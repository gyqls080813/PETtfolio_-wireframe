    ...
    <div className="min-h-screen bg-[#F5F5F8] flex items-center justify-center p-4" style={{ fontFamily: "'Noto Sans KR', sans-serif" }}>
      <div className="w-full max-w-[400px]">
        ...
        <div className="flex flex-col items-center mb-6">
          <PawPrint className="w-8 h-8 text-[#6C5CE7] mb-2" />
        ...
        <div className="bg-white rounded-2xl border border-[#E0E0E0] p-6 space-y-4">
          ...
          <div className="border border-[#EEE] rounded-lg p-3 space-y-2">
            <button className="flex items-center gap-2 w-full" onClick={toggleAll}>
              <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${agreements.every(Boolean) ? "bg-[#6C5CE7] border-[#6C5CE7]" : "border-[#CCC]"}`}>
            ...
            <div className="border-t border-[#EEE] pt-2 space-y-2">
              {terms.map((t, i) => (
                <button key={i} className="flex items-center gap-2 w-full" onClick={() => toggle(i)}>
                  <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-colors ${agreements[i] ? "bg-[#6C5CE7] border-[#6C5CE7]" : "border-[#CCC]"}`}>
