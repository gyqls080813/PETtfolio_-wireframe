          ...
          >
            ...
            >
              ...
              <div className="flex gap-2.5">
                <button
                  className="flex-1 py-3 bg-[#F5E6D0] text-[#6B4F3A] rounded-[12px] text-[14px] font-bold hover:bg-[var(--app-border)] transition-colors"
                  onClick={(e) => { e.stopPropagation(); alert('외부 계좌에서 페이 채우기 기능은 준비 중입니다.'); }}
                >
                  채우기
                </button>
                <button
                  ...
                  onClick={(e) => { e.stopPropagation(); alert('외부 계좌로 송금하기 기능은 준비 중입니다.'); }}
                >
                  보내기
                </button>
              </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-1 -ml-2">
                <button
                  ...
                  className={`p-1 rounded-full transition-colors ${selectedAccount === "shared" ? "opacity-30 cursor-not-allowed" : "hover:bg-[var(--app-bg-tertiary)] active:bg-[#F5E6D0]"}`}
                >
                ...
                <button
                  ...
                  className={`p-1 rounded-full transition-colors ${selectedAccount === "emergency" ? "opacity-30 cursor-not-allowed" : "hover:bg-[var(--app-bg-tertiary)] active:bg-[#F5E6D0]"}`}
                >
            ...
            <div className="space-y-1 overflow-y-auto pr-2 flex-1 min-h-0">
              ...
              {filteredHistory.length > 0 ? (
                filteredHistory.map((tx) => (
                  <div key={tx.id} className="flex items-center justify-between py-3.5 px-2 hover:bg-[var(--app-bg-tertiary)] rounded-2xl transition-colors cursor-pointer group -mx-2">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full overflow-hidden shrink-0 flex items-center justify-center shadow-[inset_0_0_0_1px_rgba(0,0,0,0.05)]">
                        <div className={`w-full h-full ${tx.type === "in" ? "bg-[#E8F5E4]" : "bg-[var(--app-bg-tertiary)]"} flex items-center justify-center`}>
                          <img
