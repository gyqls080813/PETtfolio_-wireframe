      ...
      <div className="flex gap-1 bg-[#F5EDDF] rounded-xl p-1">
        {[
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-[13px] transition-all ${tab === t.key ? "bg-white text-[#6B4F3A] shadow-sm" : "text-[#B4A08A]"
              }`}
